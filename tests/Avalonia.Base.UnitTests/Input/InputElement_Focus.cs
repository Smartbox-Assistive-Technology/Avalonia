...
namespace Avalonia.Base.UnitTests.Input
{
    public class InputElement_Focus
    {
        ...
        [Fact]
        public void Focus_Should_Skip_Disabled_Elements()
        {
            using (UnitTestApplication.Start(TestServices.RealFocus))
            {
                var target1 = new Button { Focusable = true, Content = "1" };
                var skip1 = new Button { IsEnabled = false, Focusable = true, Content = "s1" };
                var target2 = new Button { Focusable = true, Content = "2" };
                var skip2 = new Button { IsEnabled = false, Focusable = true, Content = "s2" };
                var target3 = new Button { Focusable = true, Content = "3" };
                var container = new StackPanel
                {
                    Children =
